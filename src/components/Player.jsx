...
const Player = () => {
  ...
  return (
    <section id="player" className="d-flex">
      <div id="cover" className="d-flex justify-content-center align-items-center">
        {cover}
      </div>
      <div id="controls" className="d-flex justify-content-center align-items-center flex-grow-1">
        <PlayerControls />
      </div>
